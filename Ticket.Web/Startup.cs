...
namespace Ticket.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<TicketAppUser>(options => options.SignIn.RequireConfirmedAccount = true)
            ...
            services.AddTransient<IOrderService, Ticket.Service.Implementation.OrderService>();
        ...
        {
            StripeConfiguration.ApiKey = Configuration.GetSection("Stripe")["Secret"];
